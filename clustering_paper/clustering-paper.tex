...
\CRANpkg{spotoroo}. The released version can be installed from CRAN
...
The main function of the \CRANpkg{spotoroo} package is
...
The clustering result shows that 407 bushfires are identified from 75936
hotspots.
