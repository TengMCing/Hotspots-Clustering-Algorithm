...
\caption[Description]{Description}\label{fig:step2figs}
\end{figure}
\end{Schunk}
...
\caption[Description]{Description}\label{fig:step3figs}
\end{figure}
\end{Schunk}
...
\begin{center}\includegraphics[width=0.8\linewidth]{clustering_paper_files/figure-latex/unnamed-chunk-4-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{clustering_paper_files/figure-latex/unnamed-chunk-7-1} \end{center}
